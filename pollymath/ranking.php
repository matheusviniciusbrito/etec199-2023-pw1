    ...
    <div id="principal">
        ...
        <div class="ranking-main">
            <div class="ranking">
                ...
                // Corrigindo a consulta SQL para obter usuários ordenados por xp_total DESC
                $sql = "SELECT nome, xp_total, link_foto FROM usuario ORDER BY xp_total DESC";
                
                $result = $conexao->query($sql);
            
                while ($user_data = mysqli_fetch_assoc($result)) {
                    echo("<div class=\"ranker-user\">");
                    
                    // Verifica se o link_foto não está vazio antes de exibi-lo
                    if (!empty($user_data['link_foto'])) {
                        echo("<img src='".$user_data['link_foto']."' alt='Foto do Usuário'>");
                    } else {
                        // Pode exibir uma imagem padrão ou mensagem de ausência de foto
                        echo("<img src='https://vagueanotherinstructionset--gabriellima146.repl.co/images-removebg-preview%20(1).png' alt='Foto Indisponível'>");
                    }

                    echo("<h1>" . $user_data['nome'] . "</h1>");
                    echo("<div class=\"XP\">" . $user_data['xp_total'] . "<span>XP</span></div>");
                    echo("</div>");
                }
            ?>           
        ...
        <div class="sidebar-responsive">
            ...
            <div onclick="ranking()" class="selecionado">
